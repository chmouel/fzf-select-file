...
_fzf_select_file() {
    local choices=(${(f)"$(eza ${=ZSH_FZF_SELECT_FILE_EXA_ARGS} .|fzf --bind="ctrl-v:change-preview-window(nohidden)" --preview="${ZSH_FZF_SELECT_FILE_FZF_PREVIEW}" ${=ZSH_FZF_SELECT_FILE_FZF_ARGS})"})
